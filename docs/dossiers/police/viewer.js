(() => {
  ...
  const sources = {
    ...
    "peregrine-2026-agenda-package": { title: "August 4, 2026 City Council Agenda Package", description: "Official City agenda package containing the Peregrine platform record considered as Agenda Item G.14.", type: "Official agenda package · PDF", date: "August 4, 2026", format: "pdf", url: "https://documents.beaumontintelligence.com/official-documents/2026-08-04/august-4-2026-city-council-agenda-package.pdf" },
