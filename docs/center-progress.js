(() => {
  const configs = {
    ...
    'downtown': { percent: 65, level: 'Building', tasks: ['Add the September 2, 2025 GHD design-contract transcript, final vote, and executed agreement.', 'Reconcile CD03, R25-15, property, incentive, contract, expenditure, and remaining-balance records.', 'Publish current design deliverables, milestone schedule, mobility analysis, amendments, and construction decisions.'] }
  };
