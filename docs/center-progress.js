(() => {
  const configs = {
    ...
    'police': { percent: 80, level: 'Strong', tasks: ['Complete current authorized-versus-filled staffing, vacancy, deployment, workload, response-time, and outcome trends.', 'Reconcile the new police station’s current site, space program, estimate basis, financing strategy, design, delivery, and schedule.', 'Complete technology implementation, audit, complaint, retention, data-sharing, and measured-outcome records.'] },
