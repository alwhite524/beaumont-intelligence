(() => {
  const configs = {
    ...
    'police': { percent: 75, level: 'Developing', tasks: ['Complete the Beaumont PD Technology dossier with contracts, policies, inventories, costs, audits, complaints, and outcomes for each verified system.', 'Reconcile Flock’s 30-day portal disclosure with Policy 465’s one-year server-retention language.', 'Complete staffing trends and police-station scope, funding, design, schedule, and construction records.'] },
